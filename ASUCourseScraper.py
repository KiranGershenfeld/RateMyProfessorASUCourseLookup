...
def CreateTeacherList():
    ...
    url = "https://webapp4.asu.edu/catalog/myclasslistresults?t=2201&s=" + userDepartment + "&n=" + userClassNumber + "&hon=F&promod=F&c=TEMPE&e=open&page=1&col=D&ord=desc"
...
#Use this function to get the quality of professors teaching a class from RMP
    ...
    for professor in ProfessorsTeachingThisClass:
        ...
        if response["numFound"] > 0:
            ...
            if profData["total_number_of_ratings_i"] > 0:
                ...
                #Ask Ratemyprofessor for data for this teacher
                ...
                description = ["Overall Quality", "Would Take Again", "Difficulty"]
                descriptionNumber = 0
                for grade in RMPSoup.findAll("div", {"class":"grade"}):
